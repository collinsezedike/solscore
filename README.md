...
- A solscore Greeter Solana program written in Anchor
...
```shell
pnpm create solana-dapp@latest -t gh:solana-foundation/templates/gill/solscore
```
...
the constant in the `anchor/src/solscore-exports.ts` file.
