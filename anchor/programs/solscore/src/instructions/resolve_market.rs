...
pub fn _resolve_market(ctx: Context<ResolveMarket>, winning_team_index:u8) -> Result<()> {
     let market = &mut ctx.accounts.market;
        ...
        require!((winning_team_index as usize) < market.teams.len(), SolscoreError::InvalidTeamIndex);
        ...
        msg!("Market resolved: Team {} wins {}", 
             winning_team_index, market.teams[winning_team_index as usize]);
    Ok(())
}
