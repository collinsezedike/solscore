...
export const SOLSCORE_ERROR__MARKET_RESOLVED = 0x1770; // 6000
/** MarketNotResolved: Market has not been resolved */
export const SOLSCORE_ERROR__MARKET_NOT_RESOLVED = 0x1771; // 6001
/** InvalidBetAmount: Bet amount must be greater than zero */
export const SOLSCORE_ERROR__INVALID_BET_AMOUNT = 0x1772; // 6002
/** BetNotWon: Bet team index does not match market winning team index */
export const SOLSCORE_ERROR__BET_NOT_WON = 0x1773; // 6003
/** InsufficientBalance: Insufficient USDC balance */
export const SOLSCORE_ERROR__INSUFFICIENT_BALANCE = 0x1774; // 6004
/** InvalidTeamIndex: Invalid team index */
export const SOLSCORE_ERROR__INVALID_TEAM_INDEX = 0x1775; // 6005
/** MathOverflow: Mathematical overflow */
export const SOLSCORE_ERROR__MATH_OVERFLOW = 0x1776; // 6006
...
if (process.env.NODE_ENV !== 'production') {
  solscoreErrorMessages = {
    ...
    [SOLSCORE_ERROR__INVALID_BET_AMOUNT]: `Bet amount must be greater than zero`,
